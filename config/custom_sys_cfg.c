...
/************************************************************************/
/* Define the working mode of emerg_off pin.                            */
/* NOTES:                                                               */
/*     The configuration on emerg_off pin is based on the power key     */
/*     isn't connected to GND directly.                                 */
/************************************************************************/
static const ST_EmergOffCfg emergoffCfg = {
    EMERGOFF_POWEROFF
};
static const ST_ExtWatchdogCfg wtdCfg = {
    PINNAME_GPIO0,  // Specify a pin which connects to the external watchdog
...
const ST_SystemConfig SystemCfg[] = {
    ...
    {SYS_CONFIG_EMERGOFF_DATA_ID,   SYS_CONFIG_EMERGOFF_DATA_SIZE, (void*)&emergoffCfg },
