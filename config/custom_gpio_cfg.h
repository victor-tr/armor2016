...
GPIO_ITEM(PINNAME_STATUS,         PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLDOWN)
...
GPIO_ITEM(PINNAME_GPIO9,           PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLUP)
GPIO_ITEM(PINNAME_GPIO10,           PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLUP)
...
GPIO_ITEM(PINNAME_SIM_PRESENCE,   PINDIRECTION_OUT,    PINLEVEL_LOW,  PINPULLSEL_PULLUP)
